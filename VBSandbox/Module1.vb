Module Module1
    ...
    Sub Main()
        'Dim txt As String = "0x927C"
        'Dim number = Convert.ToInt32("0x927C", 16)
        'Console.WriteLine(Convert.ToInt32("&H927C", 16).ToString())
        Dim input As String = "&H0010"
        Dim value As Integer = Val(input)
        Console.WriteLine(value)
        input = "9c9b"
        value = Val(input)
        Console.WriteLine(Convert.ToInt64(input, 16).ToString())
        'Console.WriteLine(Convert.ToInt32("&H10D", 16).ToString())
        'Console.WriteLine(Convert.ToInt32("&H10E", 16).ToString())
        Console.Read()
    End Sub
